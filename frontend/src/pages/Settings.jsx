...
export default function SettingsPage() {
  ...
  const [chats, setChats] = useState([]); // <--- EMPTY ARRAY FOR BACKEND CHAT DATA
  ...
  // Backend-ready menu array (if desired later)
  const navItems = [
                      ...
                      <div>
                        ...
                        <div className="space-y-6">
                          ...
                          <button 
                            ...
                            className="px-6 py-2 bg-[#89ce94] text-white rounded-lg hover:bg-[#7dc987]"
                          >
                            Save Changes
                          </button>
                        </div>
                    ...
                    {activeTab === 'delete-chats' && (
                      <div>
                        ...
                        <div className="p-6 border-2 border-[#86a59c] rounded-lg bg-gray-50">
                          <h3 className="font-semibold mb-2">Delete All Chats</h3>
